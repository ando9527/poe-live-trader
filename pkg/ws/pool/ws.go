...
func getSimChromeCookie() (header http.Header) {
	...
	//header.AddIgnored("Connection", "Upgrade")
	header.Add("Host", "www.pathofexile.com")
	header.Add("Origin", "https://www.pathofexile.com")
	header.Add("Pragma", "no-cache")
	//header.AddIgnored("Sec-WebSocket-Extensions", "permessage-deflate; client_max_window_bits")
	//header.AddIgnored("Sec-WebSocket-Key", "Oa+B/nEJMeezec/bNsjTwg==")
	//header.AddIgnored("Sec-WebSocket-Version", "13")
	//header.AddIgnored("Upgrade", "websocket")
